...
interface MenuLayoutProps {
  fabAnimatedStyle: Record<string, unknown>;
  animatedStrokeProps: Record<string, unknown>;
  hamburgerIconStyle: Record<string, unknown>;
  xIconStyle: Record<string, unknown>;
  onPress: () => void;
  pentagonPath: string;
}
